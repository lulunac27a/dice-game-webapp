...
const diceModeSelection = document.getElementById("diceMode"); //dice mode selection
...
rollDiceButton.addEventListener("click", () => {
    ...
    const numSides =
        diceModeSelection.value === "custom"
            ? parseInt(numberOfSidesInput.value, 10)
            : 6; //get number of sides input value as integer based on selected dice mode
